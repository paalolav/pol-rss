 ...
 */
class PropertyPaneLayoutPickerField {
    constructor(props) {
     ...
     */
    _updateSelection(selectedLayout) {
        var _a;
        const buttons = (_a = this._element) === null || _a === void 0 ? void 0 : _a.querySelectorAll('.ms-PropertyPaneLayoutPicker-option');
        buttons === null || buttons === void 0 ? void 0 : buttons.forEach(btn => {
            const isSelected = btn.dataset.layout === selectedLayout;
 ...
 */
export function PropertyPaneLayoutPicker(props) {
    return new PropertyPaneLayoutPickerField(props);
}
//# sourceMappingURL=PropertyPaneLayoutPicker.js.map