    ...
    const content = (() => {
        ...
        switch (props.layout) {
            ...
            case 'minimal':
                return (React.createElement(RssErrorBoundary, null,
                    React.createElement(React.Suspense, { fallback: React.createElement(LayoutFallback, null) },
                        React.createElement(MinimalLayout, { items: filteredItems, showPubDate: props.showPubDate, showDescription: props.showDescription, showSource: props.showSource, truncateDescription: 100, isLoading: isLoading }))));
            case 'gallery':
                return (React.createElement(RssErrorBoundary, null,
                    React.createElement(React.Suspense, { fallback: React.createElement(LayoutFallback, null) },
