 ...
 * MinimalLayout component
 */
export const MinimalLayout = ({ items, showPubDate = true, showDescription = false, showSource = false, truncateDescription = 80, isLoading = false, skeletonCount = 5, onItemClick, className = '', testId = 'minimal-layout', isInverted = false }) => {
    // Handle item click
