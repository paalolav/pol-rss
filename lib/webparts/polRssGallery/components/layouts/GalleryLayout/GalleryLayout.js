 ...
 * GalleryLayout component
 */
export const GalleryLayout = ({ items, columns = 'auto', gap = 'md', showTitles = 'below', aspectRatio = '4:3', fallbackImageUrl, forceFallback = false, filterNoImages = true, isLoading = false, skeletonCount = 8, onItemClick, className = '', testId = 'gallery-layout' }) => {
