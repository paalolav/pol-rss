 ...
 * GalleryItem component
 */
export const GalleryItem = ({ item, showTitle, aspectRatio, fallbackImageUrl, forceFallback = false, showDate = true, showDescription = false, showSource = false, onClick, className = '', testId = 'gallery-item', isInverted = false }) => {
    ...
    return (React.createElement("article", { className: itemClasses, onClick: handleClick, onKeyDown: handleKeyDown, tabIndex: 0, role: "link", "aria-label": item.title, "data-testid": testId },
        React.createElement("div", { className: styles.imageWrapper, style: imageWrapperStyle },
            ...
            showTitle === 'hover' && (React.createElement("div", { className: styles.hoverOverlay, "data-testid": `${testId}-hover-overlay` },
                ...
                showDate && item.pubDate && (React.createElement("time", { className: styles.date, dateTime: item.pubDate }, formatDate(item.pubDate))),
                showSource && item.author && (React.createElement("span", { className: styles.source }, item.author)),
                showDescription && processedDescription && (React.createElement("p", { className: styles.description }, truncateText(processedDescription, 100)))))),
        showTitle === 'below' && (React.createElement("div", { className: styles.titleBelow, "data-testid": `${testId}-title-below` },
            ...
            (showDate || showSource) && (React.createElement("div", { className: styles.meta },
                showDate && item.pubDate && (React.createElement("time", { className: styles.date, dateTime: item.pubDate }, formatDate(item.pubDate))),
                showDate && item.pubDate && showSource && item.author && (React.createElement("span", { className: styles.separator }, "\u2022")),
                showSource && item.author && (React.createElement("span", { className: styles.source }, item.author)))),
            showDescription && processedDescription && (React.createElement("p", { className: styles.description }, truncateText(processedDescription, 80)))))));
};
