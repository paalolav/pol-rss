 ...
 * CardLayout component
 */
export const CardLayout = ({ items, columns = 'auto', cardSize = 'md', gap = 'md', fallbackImageUrl, forceFallback = false, hideImages = false, showPubDate = true, showDescription = true, showSource = false, truncateDescription = 150, imageAspectRatio = '16:9', isLoading = false, skeletonCount = 6, onItemClick, className = '', testId = 'card-layout' }) => {
