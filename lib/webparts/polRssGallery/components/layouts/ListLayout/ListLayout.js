...
export const ListLayout = ({ items, thumbnailPosition = 'left', thumbnailSize = 'md', compact = false, showDividers = true, fallbackImageUrl, forceFallback = false, hideImages = false, showPubDate = true, showDescription = true, showSource = false, truncateDescription = 200, isLoading = false, skeletonCount = 5, onItemClick, className = '', testId = 'list-layout', isInverted = false }) => {
    ...
    return (React.createElement("div", { className: containerClasses, "data-testid": testId, key: layoutKey, role: "list", "aria-label": "Nyhetsliste" }, items.map((item, index) => (React.createElement("div", { key: `${item.link}-${index}`, className: styles.listItem, role: "listitem" },
        React.createElement(FeedItem, { item: item, variant: "list", showImage: !hideImages && thumbnailPosition !== 'none', showDescription: showDescription, showDate: showPubDate, showSource: showSource, imageAspectRatio: thumbnailSizeToAspectRatio[thumbnailSize], fallbackImageUrl: fallbackImageUrl, forceFallback: forceFallback, onItemClick: handleItemClick, descriptionTruncation: {
