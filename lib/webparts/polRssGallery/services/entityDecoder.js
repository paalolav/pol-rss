 ...
 */
export function decodeNumericEntity(entity) {
 ...
 */
export function hasDoubleEncodedEntities(text) {
 ...
 */
function hasEncodedEntities(text) {
 ...
 * ```
 */
export function decodeEntities(text, options = {}) {
    if (!text) {
        return text;
    }
 ...
 */
export function decodeEntitiesInHtml(html) {
    if (!html) {
        return html;
    }
